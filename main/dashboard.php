...
<head>
  ...
  <link rel="stylesheet" href="/anyeong/style/dashboard.css">
  <title>Anyeong~</title>
      ...
      <div class="sidebar flex-column">
        ...
        <div class="nav">
          <ul>
            ...
            <li class="active">
                <a href="logout" onclick="return confirm('Apakah anda yakin untuk keluar?');" class="nav-link">
                    <i class="icon-nav">
      ...
      <div class="main-board">
        ...
        <div class="greet">
            <div class="salam">
                ...
                <img src="/anyeong/assets/img/ikonkpop.png" alt="">
            </div>
        </div>
        <div class="board">
                  ...
                  ?>
                    <tbody>
                      <tr>
                        ...
                        <td><?= $data[$i]["Count"];?></td>
                        <td>
                            <img src="uploads/<?= $data[$i]['Photo'] ?>" alt="" width="100px">
                        </td>
                        <td>
                          <div>
                          <a href="/tugas_individu_going_to_php/main/editdata/<?=$data[$i]['id']?>">
                          ...
                          <div>
                            <a href="cont.php?id=<?= $row['id'] ?>&proses=remove" onclick="return confirm('Do you want to delete : <?= $row['Seller']?> ?');">
                            <svg width="33" height="33" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
